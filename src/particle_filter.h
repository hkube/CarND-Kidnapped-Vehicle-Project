...
class ParticleFilter {
 ...
 public:
  ...
  typedef struct
  {
	 ...
	 */
	void init(double x, double y, double theta, const Sigma3 std);
	 ...
	 */
	void prediction(double delta_t, const Sigma3 std_pos, double velocity, double yaw_rate);
